import{aT as c,cS as h,cz as e,cT as o,cU as n,cV as p,cW as d,cX as m,cY as t,cZ as f,c_ as F,c$ as v,d0 as u,d1 as E,d2 as M,d3 as H,d4 as B}from"./index-fd387731.js";import{l as I,m as V,q as A,r as k}from"./index-9a3843ab.js";import{I as x}from"./Layout-7a7a4715.js";import{a as D}from"./index-6f8a4175.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function L(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function P(a){return c({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":F,"exe,msi":v,apk:x,db:I,md:u,epub:V,iso:A,m3u8:t,"doc,docx":E,"xls,xlsx":M,"ppt,pptx":H,pdf:B,psd:L,ai:Z,url:k,cast:D},S=(a,i)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(e(i))return o}switch(a){case l.FOLDER:return f;case l.VIDEO:return t;case l.AUDIO:return m;case l.TEXT:return d;case l.IMAGE:return p;default:return n}},W=a=>S(a.type,a.name);export{P as A,l as O,W as g};
